...
// event requires it)
type TEventInit<T> = T extends keyof GlobalEventHandlersEventMap
  ? GlobalEventHandlersEventMap[T] extends CustomEvent<
      Record<PropertyKey, unknown>
    >
    ? GlobalEventHandlersEventMap[T] extends CustomEvent<
...
export default class TallyElement extends LitElement {
...
export interface TallyFormControl extends TallyElement {
  // Form attributes
  name: string;
  value: unknown;
  disabled?: boolean;
